...
创建一个字典并输出:
    ...
    NSMutableSet *set = [NSMutableSet setWithArray:@[@"set0",
                                                     strData,
                                                     dicData]];
    NSDictionary *dic = @{@"name"  : @"Jazzhow",
                           @"My bolg" : @"http://jazzhow.github.io",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"zihao Blog:http://jazzhow.github.io",
                                          @"GitHub:https://github.com/jazzhow",
                                          @"简书:https://http://www.jianshu.com/u/d234573035aa"]};
    NSLog(@"%@", dic);
...
输出结果：
	...
	2017-03-01 10:36:45.709 BYFoundationLog_Demo[1657:53604] {
	    ...
	    contact =     (
	        "zihao Blog:http://jazzhow.github.io",
	        "GitHub:https://github.com/jazzhow",
	        "\U7b80\U4e66:https://http://www.jianshu.com/u/d234573035aa"
	    );
	    count = 11;
...
代码及Demo地址：[GitHub](https://github.com/jazzhow/BYFoundationLog)
